...
# Watcher class
class BitVCBWWatcher (coinwatcher.CoinWatcher):
    ...
    def fetchData ( self ):
        ...
        if ( (time.time()-self.CNY_USD_stamp) > 3600.0 ):
            try:
                ...
                pass
        trades = '/futures/trades_btc_next_week.js'
        ed = coinwatcher.CoinWatcher.fetchData ( self, httplib.HTTPSConnection, 'market.bitvc.com', '/futures/depths_btc_next_week.js', trades )
        return ed
...
if __name__ == "__main__":
    coinwatcher.main ( 'BitVCBiWeekly', 'bitvcbiweekCNY', BitVCBWWatcher )
