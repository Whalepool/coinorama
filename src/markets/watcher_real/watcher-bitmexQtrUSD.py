...
# Watcher class
class BitMEXXBU7DWatcher (coinwatcher.CoinWatcher) :
    ...
    def fetchData ( self ):
        trades = '/api/v1/trade?symbol=XBTM17&reverse=true'
        ed = coinwatcher.CoinWatcher.fetchData ( self, httplib.HTTPSConnection, 'www.bitmex.com', '/api/v1/orderBook?symbol=XBTM17&depth=100', trades )
        return ed
...
if __name__ == "__main__":
    coinwatcher.main ( 'BitMEXQuarterlies', 'bitmexQtrUSD', BitMEXXBU7DWatcher )
