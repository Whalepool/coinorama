...
# Watcher class
class BitVCWWatcher (coinwatcher.CoinWatcher):
    ...
    def fetchData ( self ):
        ...
        ed = coinwatcher.CoinWatcher.fetchData ( self, httplib.HTTPSConnection, 'market.bitvc.com', '/futures/depths_btc_week.js', trades )
        return ed
