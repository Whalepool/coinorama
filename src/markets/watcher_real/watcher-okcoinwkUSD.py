...
# Watcher class
class OKCoinUSDFWWatcher (coinwatcher.CoinWatcher):
    ...
    def fetchData ( self ):
        ...
        ed = coinwatcher.CoinWatcher.fetchData ( self, httplib.HTTPSConnection, 'www.okcoin.com', '/api/v1/future_depth.do?symbol=btc_usd&contract_type=this_week', trades )
        return ed
