...
# Watcher class
class OKCoinLTCbiWatcher (coinwatcher.CoinWatcher):
    ...
    def fetchData ( self ):
        ...
        ed = coinwatcher.CoinWatcher.fetchData ( self, httplib.HTTPSConnection, 'www.okcoin.com', '/api/v1/future_depth.do?symbol=ltc_usd&contract_type=next_week', trades )
        return ed
