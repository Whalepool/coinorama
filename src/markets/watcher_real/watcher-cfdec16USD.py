...
# Watcher class
class CFDec16Watcher (coinwatcher.CoinWatcher) :
    ...
    def fetchData ( self ):
        trades = '/derivatives/api/tradingdata/trades?contract=F-XBT:USD-Dec16&since=%d' %  int ( self.mostRecentTransactionID )
        ed = coinwatcher.CoinWatcher.fetchData ( self, httplib.HTTPSConnection, 'www.cryptofacilities.com', '/derivatives/api/cumulativebidask?tradeable=F-XBT:USD-Dec16&unit=USD', trades )
        return ed
