...
# Watcher class
class CFSep16Watcher (coinwatcher.CoinWatcher) :
    ...
    def fetchData ( self ):
        trades = '/derivatives/api/tradingdata/trades?contract=F-XBT:USD-Sep16&since=%d' %  int ( self.mostRecentTransaction )
        ed = coinwatcher.CoinWatcher.fetchData ( self, httplib.HTTPSConnection, 'www.cryptofacilities.com', '/derivatives/api/cumulativebidask?tradeable=F-XBT:USD-Sep16&unit=USD', trades )
        return ed
